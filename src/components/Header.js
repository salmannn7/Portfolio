    ...
    return (
        <header className="h-24 w-full flex items-center justify-center fixed z-50 font-poppins font-light uppercase pointer-events-none">
            ...
            <nav className="h-auto w-auto rounded-full overflow-hidden pointer-events-auto">
                <div className="h-auto w-auto flex text-white text-xl divide-x-2 divide-zinc-900">
                    <div onClick={() => scrollToSection("about")} className={`flex items-center justify-center w-full h-full py-4 px-6 cursor-pointer fade-in ${activeSection === "about" ? "nav-button-active" : "nav-button"}`} style={{ animationDelay: "0.2s" }}>
                        <p className="pointer-events-none">About</p>
                    </div>
                    <div onClick={() => scrollToSection("projects")} className={`flex items-center justify-center w-full h-full py-4 px-6 cursor-pointer fade-in ${activeSection === "projects" ? "nav-button-active" : "nav-button"}`} style={{ animationDelay: "0.4s" }}>
                        <p className="pointer-events-none">Projects</p>
                    </div>
                    <div onClick={() => scrollToSection("skills")} className={`flex items-center justify-center w-full h-full py-4 px-6 cursor-pointer fade-in ${activeSection === "skills" ? "nav-button-active" : "nav-button"}`} style={{ animationDelay: "0.6s" }}>
                        <p className="pointer-events-none">Skills</p>
                    </div>
                    <div onClick={() => scrollToSection("contact")} className={`flex items-center justify-center w-full h-full py-4 px-6 cursor-pointer fade-in ${activeSection === "contact" ? "nav-button-active" : "nav-button"}`} style={{ animationDelay: "0.8s" }}>
