...
function Test() {
    ...
    const toggleCentered = () => {
        ...
        if (aboutRef.current) {
            for (let x = 0; x < aboutRef.current.length; x++) {
                ...
                if (newCentered) {
                    // Center the elements
                    const width = aboutSectionRef.current.offsetWidth;
                    const aboutWidth = aboutElement.offsetWidth;
                    const margin = width - aboutWidth;
                    aboutElement.style.marginLeft = `${margin / 2}px`;
                    aboutElement.style.marginRight = `${margin / 2}px`;
                } else {
                    // Reset to default margins
                    if (x === 0 || x === 2) {
                        aboutElement.style.marginLeft = `auto`;
                        aboutElement.style.marginRight = `0`;
                    } else {
                        aboutElement.style.marginLeft = `0`;
                        aboutElement.style.marginRight = `auto`;
                    }
                }
    ...
    return (
        <div className="w-full font-poppins font-light">
            <div className="w-full min-h-screen h-screen flex flex-col gap-4 items-center justify-center text-3xl text-white snap-start">
                <div className="w-full h-auto flex justify-center mr-12 text-nowrap">
                    <p className="">
                ...
                <div className="w-full h-auto flex justify-center ml-12 text-nowrap">
                    <p>
            ...
            <div data-section="about" className="w-full min-h-screen">
                <div ref={(el) => (sectionsRefs.current[1] = el)} className="w-full h-screen flex flex-col items-center justify-center text-white text-6xl snap-start">
                ...
                <div className="w-full min-h-screen">
                    <div ref={(el) => (sectionsRefs.current[2] = el)} className="w-full min-h-screen pt-24 snap-start">
                        <div className="w-full h-12 text-5xl text-white font-medium flex items-center justify-center text-center mb-4 fade-child">
                            <p>ABOUT ME</p>
                        </div>
                        ...
                        <div className="w-full flex p-4">
                            <div ref={aboutSectionRef} className="h-full w-full flex flex-col justify-center text-white text-justify fade-child about-div relative">
                                <div ref={(el) => (aboutRef.current[0] = el)} className="min-h-1/4 max-h-72 w-72 overflow-hidden rounded-xl aspect-square bg-zinc-950 text-sm p-2 flex items-center z-50 about-box-mobile relative fade-child">
                                    <img className="w-full h-auto rounded-xl fade-child" src={aviPro} alt="graduation picture" />
                                </div>
                                <div ref={(el) => (aboutRef.current[1] = el)} className="min-h-1/4 max-h-72 w-72 rounded-xl aspect-square bg-zinc-950 text-xs p-2 flex items-center z-40 about-box-mobile relative fade-child">
                                ...
                                <div ref={(el) => (aboutRef.current[2] = el)} className="min-h-1/4 max-h-72 w-72 rounded-xl aspect-square bg-zinc-950 text-xs p-2 flex items-center z-30 about-box-mobile relative fade-child">
                                ...
                                <div ref={(el) => (aboutRef.current[3] = el)} className="min-h-1/4 max-h-72 w-72 rounded-xl aspect-square bg-zinc-950 text-xs p-2 flex items-center z-20 about-box-mobile relative fade-child">
                    ...
                    <div ref={(el) => (sectionsRefs.current[3] = el)} className="w-full min-h-screen pt-24 snap-start">
                        ...
                        <div className="w-full flex flex-col gap-4 p-4">
                            <div>
                                <div className={`w-full min-h-32 bg-zinc-950 text-white flex flex-col justify-center fade-child ${hasAnimated ? 'fade-in' : ''} ${isLevel6Visible ? "rounded-t-xl" : "rounded-xl"}`}>
                                    <div className="w-full h-32 flex items-center">
                                        <img src={mmuLogo} className="h-24 w-auto p-4 fade-child" />
                                    ...
                                    <div className="h-fit w-full flex items-center justify-center p-4 gap-1 cursor-pointer" onClick={toggleLevel6Visibility}>
                            ...
                            <div>
                                <div className={`w-full min-h-32 bg-zinc-950 text-white flex flex-col justify-center fade-child ${hasAnimated ? 'fade-in' : ''} ${isCollegeVisible ? "rounded-t-xl" : "rounded-xl"}`}>
                                    <div className="w-full h-32 flex items-center">
                                        <img src={osfcLogo} className="h-24 w-auto p-4 fade-child" />
                                        <div className="flex flex-col justify-center">
                                    ...
                                    <div className="h-fit w-full flex items-center justify-center p-4 gap-1 cursor-pointer" onClick={toggleCollegeVisibility}>
                            ...
                            <div>
                                <div className={`w-full min-h-32 bg-zinc-950 text-white flex flex-col justify-center fade-child ${hasAnimated ? 'fade-in' : ''} ${isSecondaryVisible ? "rounded-t-xl" : "rounded-xl"}`}>
                                    <div className="w-full h-32 flex items-center">
                                        <img src={trsLogo} className="h-24 w-auto p-4 fade-child" />
                                        <div className="flex flex-col justify-center">
                                    ...
                                    <div className="h-fit w-full flex items-center justify-center p-4 gap-1 cursor-pointer" onClick={toggleSecondaryVisibility}>
            ...
            <div data-section="projects" className="w-full min-h-screen">
                <div ref={(el) => (sectionsRefs.current[4] = el)} className="w-full h-screen flex flex-col items-center justify-center text-white text-6xl snap-start">
            ...
            <div data-section="skills" className="w-full min-h-screen">
                <div ref={(el) => (sectionsRefs.current[7] = el)} className="w-full h-screen flex flex-col items-center justify-center text-white text-6xl snap-start">
                ...
                <div className="w-full min-h-screen">
                    <div ref={(el) => (sectionsRefs.current[8] = el)} className="w-full min-h-screen pt-24 snap-start">
                        ...
                        <div className="w-full flex flex-col gap-4 p-4 text-white">
                            <div className="w-full max-h-1/3 bg-zinc-950 rounded-xl p-2 flex flex-col fade-child">
            ...
            <div data-section="contact" className="w-full min-h-screen">
                <div ref={(el) => (sectionsRefs.current[10] = el)} className="w-full h-screen flex flex-col items-center justify-center text-white text-6xl snap-start">
                ...
                <div className="w-full min-h-screen">
                    <div ref={(el) => (sectionsRefs.current[11] = el)} className="w-full min-h-screen pt-24 snap-start">
                        <div className="w-full h-12 text-5xl text-white font-medium flex items-center justify-center text-center mb-8 fade-child">
                        ...
                        <div className="w-full p-4 flex flex-col gap-4 text-white">
                            ...
                            <div className="w-full h-full bg-zinc-950 rounded-xl p-4 grid grid-rows-5 fade-child">
                                <div>
                    ...
                    <div ref={(el) => (sectionsRefs.current[12] = el)} className="w-full min-h-screen pt-24 snap-start">
                        ...
                        <div className="w-full h-[calc(100vh-9rem)] flex flex-col gap-4 p-4 text-white">
                            <div className="w-full h-full rounded-xl bg-white overflow-hidden relative flex items-end fade-child whole-social">
                                ...
                                <div className="w-full h-1/2 bg-white relative px-2 flex z-30 social">
                                    ...
                                    <div className="w-full h-full grid grid-rows-4">
                                        ...
                                        <div className="w-full h-full text-black text-md fade-child text-nowrap">
                                            <p>BSc Software Engineering Graduate</p>
                                        </div>
                                        <div className="w-full h-full text-zinc-500 text-md fade-child text-nowrap">
