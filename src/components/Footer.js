            ...
            <div className="absolute w-full h-screen top-0 left-0 text-3xl flex flex-col items-center justify-center">
                <div className="w-full h-full flex flex-col items-center justify-center px-24">
                    ...
                    <div className="w-full h-fit grid grid-cols-4">
                        <div className="fade-child w-full h-fit flex flex-col items-center justify-evenly col-span-2">
                        ...
                        <div className="fade-child w-full h-full flex flex-col items-center justify-evenly col-span-2">
